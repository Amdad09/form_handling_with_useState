...
export default function AddTaskModal({ onAdd, taskToUpdate, onCloseModal }) {
    ...
    const handleChange = (e) => {
        ...
        setTask((prevTask) => ({
            ...prevTask,
            [name]: Array.isArray(prevTask[name]) ? value.split(',') : value,
        }));
    };
        ...
        <div>
            ...
            <htmlForm className="mx-auto my-10 w-full max-w-[740px] rounded-xl border border-[#FEFBFB]/[36%] bg-[#191D26] p-9 max-md:px-4 lg:my-20 lg:p-11 absolute z-10 top-1/12 left-1/3">
                <h2 className="mb-9 text-center text-2xl font-bold text-white lg:mb-11 lg:text-[28px]">
                    {isAdd ? 'Add New Task' : 'Task To Update'}
                </h2>
